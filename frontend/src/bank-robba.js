...
function gameOver(player){
  ...
  if(player == 'cop'){
    gameBox.innerHTML = `<div id='end-game' style='margin-top:200px;'>You have been <br><br> ARRESTED <br><br> The Cop Wins</div>`
  } else if(player == 'robber'){
    gameBox.innerHTML = `<div id='end-game' style='margin-top:200px;'>You have robbed the <br><br> BANK <br><br> The Robber Wins</div>`
  }
}
